          ...
          Padding(
            ...
            child: SizedBox(
              child: Row(
                children: [
                  Text(
                    expiredProperties['properties']['name'],
            ...
            child: SizedBox(
              child: Row(
                children: [
                  ...
                  Text(
                    '${(expiredProperties['per_night'].toInt()).toString()}/Night',
                  ...
                  Text(
                      "${DateFormat.d().format(DateTime.parse(expiredProperties['start_date']))}-${DateFormat.d().format(DateTime.parse(expiredProperties['end_date']))} ${DateFormat.MMM().format(DateTime.parse(expiredProperties['start_date']))} ${DateFormat.y().format(DateTime.parse(expiredProperties['start_date']))}",
